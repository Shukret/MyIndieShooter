...
namespace CoverShooter
{
    ...
    public class MobileController : MonoBehaviour
    {
        ...
        /// <summary>
        /// Should the controller automatically reload once the weapon clip is empty.
        /// </summary>
        [Tooltip("Should the controller automatically reload once the weapon clip is empty.")]
